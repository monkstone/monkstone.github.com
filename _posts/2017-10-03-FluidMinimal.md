---
layout: post
title: "Callback With Static Class Interface in JRuby"
date: 2017-10-03 07:00:00
categories: jruby_art update
keywords: ruby-processing, JRubyArt, propane, jruby
---
Previously I had only experience of implementing java callbacks with instance interfaces, but in the [PixelFlow library][pixgit] by [Thomas Diewald][diewald] he has created `static java interfaces` in `DWFluid2D.java`:-
...
See `cb_fluid_data` lambda below
...
<img src="/assets/fluid_minimal.png" />
