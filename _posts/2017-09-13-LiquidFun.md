---
layout: post
title: "LiquidFunProcessing in JRubyArt and propane"
date: 2017-09-13 06:30:00
categories: jruby_art update
keywords: ruby-processing, JRubyArt, propane, library, glsl, box2d
---
Previously we described a sketch using [Thomas Diewald][diewald] PixelFlow library in JRubyArt, the same sketch has also been translated to run with propane see [examples][examples], here we look at examples from the [LiquidFunLibrary][liquid_fun], that also uses [PixelFlow library][pixweb], for JRubyArt both libraries should be installed using the processing ide (see [alternative library installation][propane] for propane)
...
<img src="/assets/wave_machine.png" />

[propane]:https://ruby-processing.github.io/propane/contributed
[examples]:https://github.com/ruby-processing/propane-examples/tree/master/external_library/java/pixel_flow
[liquid_fun]:https://github.com/diwi/LiquidFunProcessing
