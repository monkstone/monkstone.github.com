...
Since jdk9 there has been a move toward strong encapsulation in java, however in order not to break existing code. this has been somewhat relaxed. The exception are some internal and proprietary classes that were never intended to be generally available. This is detailed in [jep-261][261] and [jep-260][260] and explained [here][mvpjava] and somewhat lucidly by [Mark Rheinhold][reinhold].
