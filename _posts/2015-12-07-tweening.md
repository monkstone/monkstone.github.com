...
Here is vanilla processing Mesh Tweening sketch translated for JRubyArt, as with other sketches that touch the 'metal', it requires to be run with the `--nojruby` flag (to use <sup>a</sup>`jruby-complete`, this is a java permissions thing).
