...
COULER = %i(jaune rose rouge bleu vert gris noir violet blanc).freeze
WEB_COULER = %w(
  #FFFF00
  #FF007F
  #FF0000
...
def setup
  ...
  cols_int = WEB_COULER.map { |col| color(col) }
  @web = COULER.zip(cols_int).to_h
  no_loop
end
